...
/**
 * Parser for ssh rsa public key format
 */

public class SshRsaPublicKeyReader {
...
//        00 c3 a3...             The modulus
    ...
    public static RSAPublicKey parseSshRsaPublicKey(String key) throws InvalidKeyException {
        ...
        try {
            if (INITIAL_PREFIX.length != is.read(prefix) || !ArrayUtils.isEqual(INITIAL_PREFIX, prefix)) {
